...
A separate successor worktree exists at `/home/ubuntu/n8n2erpnext/lightbi-control-plane-next-internal`, branch `codex/next-internal-generation-20260830`. The foundation was pushed at `c8a667cc0e760572f9aa620ca72cdc8cd5bfb41d`; exact current CP source head remains `c251fb1ee981a529c33335d25d3ada4e6ea9d23f`, which binds the NEXT control plane to the internal interface. It is currently paired by generation manifest with Core NEXT `d82bdb625b69755af51f42c01e2a35fe00731c28`; the CP source SHA remains unchanged because the intervening Core/frontend generations require identity reconciliation rather than new control-plane behavior.
