...
A separate successor worktree exists at `/home/ubuntu/n8n2erpnext/lightbi-control-plane-next-internal`, branch `codex/next-internal-generation-20260830`. The foundation was pushed at `c8a667cc0e760572f9aa620ca72cdc8cd5bfb41d`; exact latest head is now `c251fb1ee981a529c33335d25d3ada4e6ea9d23f`, which binds the NEXT control plane to the internal interface and pairs with latest Core NEXT `b1b40277e5e6e8389bc13c2c75f439fdb861600c` at the source-contract level.
