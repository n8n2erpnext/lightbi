...
This direction does **not** change the current Road-to-1.0 sequencing recorded in §106. Multi-file UX parity / Focus Subject remains the current executable next action, followed by Intelligence Pack/update trust, Signed Transport integration, and packaged Windows/UAT + integrated release acceptance. MB V1 remains source-accepted through `a1f6ee8`; Production remains untouched.
