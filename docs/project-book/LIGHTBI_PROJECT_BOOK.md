...
- Architecture direction: `Understanding + MB -> Question/Perspective Intelligence -> governed question/metric authority -> Analysis Narrative -> Visualization Intelligence -> Dashboard Composition -> Report/Presentation -> calm workspace + shared Evidence Inspector`.
