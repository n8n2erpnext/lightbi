...
The successor source generation was established at Core `ef2434ac01ec6a817f4a04f58d16ef41c447b9dc` / private control plane `c8a667cc0e760572f9aa620ca72cdc8cd5bfb41d` and has now advanced to exact latest heads Core `b1b40277e5e6e8389bc13c2c75f439fdb861600c` and control plane `c251fb1ee981a529c33335d25d3ada4e6ea9d23f`. Core lineage after the foundation adds the internal gateway (`0a9d20a`), preserves governed perspective identity in Excel export (`a875098`), and captures that Deep BA Excel identity regression in the owner UAT pack (`b1b4027`). The private sibling adds explicit internal-interface binding at `c251fb1`.
