...
The successor source generation was established at Core `ef2434ac01ec6a817f4a04f58d16ef41c447b9dc` / private control plane `c8a667cc0e760572f9aa620ca72cdc8cd5bfb41d` and has now advanced to current Internal Core head `d82bdb625b69755af51f42c01e2a35fe00731c28` with control plane still exact `c251fb1ee981a529c33335d25d3ada4e6ea9d23f`. Early lineage after the foundation added the internal gateway (`0a9d20a`), governed Excel perspective identity (`a875098`) and its UAT regression (`b1b4027`); later sections record modularization, native Pivot, SQL completion and Advanced/Easy continuity through NEXT-012. The private sibling's source head remains `c251fb1` because NEXT-009 through NEXT-012 require only Internal generation-identity reconciliation, not new CP behavior.
