...
This closes **only `cli-lightbi` Phase A / v0.1 machine acceptance**. Per owner plan, work stops before Phase B operator MFA and Phase C/D mutation helpers. R1-P11 physical Basic/Pro separation WIP remains paused on its separate worktree; Production Trust freeze/Root gates remain unchanged and Production was not mutated.
