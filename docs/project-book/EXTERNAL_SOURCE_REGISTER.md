...
- Interaction study now also covers cursor-proximity chart hover/tooltip behavior, native-scrollbar theming, contextual keyboard shortcuts, Quick Search/command-palette behavior, sidebar collapse/reveal, popover/dropdown navigation and 100–150ms motion conventions.
