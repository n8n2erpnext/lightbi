...
1. Read [`LIGHTBI_PROJECT_BOOK.md`](./LIGHTBI_PROJECT_BOOK.md) for the docs-derived project model.
2. Use this map to choose the correct shelf.
3. Use [`SOURCE_CATALOG.md`](./SOURCE_CATALOG.md) for exact source lookup and checksum.
4. Use [`PATH_MIGRATION_INDEX.md`](./PATH_MIGRATION_INDEX.md) or [`../history/LEGACY_ROOT_INDEX.md`](../history/LEGACY_ROOT_INDEX.md) when an old path is mentioned.
5. For implementation truth, consult the Code Map and later Git/CI audit; documentation alone does not prove current code behavior.

## Authority-oriented shelves

- **Onboarding / synthesis:** `docs/project-book/` — derived map, provenance, worklog, catalogs.
