...
export interface InstallationCertificatePayloadV1 { schema: 1; kid: string; product_id: string; installation_id: string; device_key_algorithm: 'Ed25519'; device_public_key: string; release_id: string; platform: 'windows' | 'linux' | 'macos'; architecture: string; issued_at: string; expires_at: string; certificate_id: string }
