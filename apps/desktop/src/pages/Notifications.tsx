...
export const Notifications:React.FC=()=>{
  ...
  return <div className="flex h-full w-full overflow-hidden bg-[#fbfbfa]">
    <section className="w-[360px] shrink-0 overflow-y-auto border-r border-black/10 bg-white/70">
      <div className="sticky top-0 z-10 border-b border-black/10 bg-white/95 px-5 py-4 backdrop-blur"><div className="flex items-center gap-2 text-sm font-semibold"><Inbox className="h-4 w-4"/>Inbox</div><p className="mt-1 text-xs text-black/45">LightBI product and service notifications are stored locally on this device.</p></div>
