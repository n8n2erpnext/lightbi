...
console.log('Opportunities length:', du.opportunities.length);
console.log('Available length:', du.availableAnalysis.length);
console.log('High confidence opps:', du.opportunities.filter(o => o.confidence !== 'low').length);
