...
export const COMMERCE_DISTRIBUTION_QUESTION_POLICY_V1 = {
  ...
  questionFamilies: [
    ...
    { questionId: "commerce.inventory_on_hand.by_product", version: "1.0.0", domainPackId: "commerce_distribution_mvp", metricId: "inventory_on_hand", title: "Which items hold the most inventory at the as-of basis?", businessPurpose: "Rank a governed point-in-time inventory balance by its bound item identity.", intent: "ranking", actionKind: "snapshot_candidate", requiredDimensionGroups: [["sku"]], timeRequirement: "point_in_time_as_of", sourceComplexity: "source_local", priority: 65, prohibitedUses: [...commonProhibitedUses, "inventory_movement_claim", "sum_across_time", "unit_conversion"] },
    { questionId: "commerce.inventory_on_hand.by_warehouse", version: "1.0.0", domainPackId: "commerce_distribution_mvp", metricId: "inventory_on_hand", title: "Which warehouses hold the most inventory at the as-of basis?", businessPurpose: "Rank a governed point-in-time inventory balance by its bound warehouse identity.", intent: "ranking", actionKind: "snapshot_candidate", requiredDimensionGroups: [["warehouse"]], timeRequirement: "point_in_time_as_of", sourceComplexity: "source_local", priority: 66, prohibitedUses: [...commonProhibitedUses, "inventory_movement_claim", "sum_across_time", "unit_conversion"] },
    { questionId: "commerce.inventory_on_hand.by_item_warehouse", version: "1.0.0", domainPackId: "commerce_distribution_mvp", metricId: "inventory_on_hand", title: "What is the inventory balance for each item and warehouse at the as-of basis?", businessPurpose: "Verify governed point-in-time inventory at its exact item and warehouse identity grain.", intent: "ranking", actionKind: "snapshot_candidate", requiredDimensionGroups: [["sku"], ["warehouse"]], timeRequirement: "point_in_time_as_of", sourceComplexity: "source_local", priority: 67, prohibitedUses: [...commonProhibitedUses, "inventory_movement_claim", "sum_across_time", "unit_conversion"] },
