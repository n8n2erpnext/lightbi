...
const CORE_ID_BY_CANONICAL: Record<string, string> = {
  ...
  income: "money.income",
  fare_amount: "money.revenue",
  tip_amount: "money.revenue",
  ...
  person_age: "entity.person_age",
  gender: "entity.gender",
  birth_date: "time.birth_date",
  ...
  transaction_error: "status.payment",
  ...
  passenger_count: "quantity.units",
  ...
  rating_score: "engagement.rating",
  survey_count: "engagement.survey_count",
  response_rate: "engagement.response_rate",
  survey_question: "engagement.survey_question",
  recommendation: "engagement.outcome",
  review_count: "engagement.review_count",
...
const CORE_COMPAT_SIGNAL_RULES: SignalRule[] = [
  ...
  { id: "location.city", family: "location", role: "dimension", label: "City", patterns: [/^city$|city[ ._-]?name|municipality|thành phố|thanh pho/i] },
  { id: "location.state_province", family: "location", role: "dimension", label: "State / Province", patterns: [/^state$|state[ ._-]?(?:code|name)|province|tỉnh thành|tinh thanh/i] },
  { id: "location.postal_code", family: "location", role: "identifier", label: "Postal Code", patterns: [/zip[ ._-]?code|postal[ ._-]?code|postcode|mã bưu chính|ma buu chinh/i], defaultUsable: false },
