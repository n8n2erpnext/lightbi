...
export const GOVERNED_RUNTIME_POLICY_V1 = {
  ...
  metricIds: ["sales_revenue", "quantity_sold", "transaction_count", "inventory_on_hand", "delivery_count", "trip_count", "average_quality_score", "gross_profit"],
  operators: {
  ...
  conditionallyExecutableMetricIds: ["sales_revenue", "quantity_sold", "transaction_count", "inventory_on_hand", "delivery_count", "trip_count", "average_quality_score"],
  rules: [
