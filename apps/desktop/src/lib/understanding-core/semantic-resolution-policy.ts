...
export const LEXICAL_CLASS_ORDER: LexicalEvidenceClass[] = ["canonical_id_exact", "canonical_label_exact", "header_alias_exact", "alias_exact", "token_containment", "semantic_retrieval", "value_only", "none"];
export const SEMANTIC_RESOLUTION_POLICY: ResolutionPolicyV1 = {
  ...
  forbiddenInference: ["weighted_score", "total_ranking", "candidate_manufacture", "context_bootstrap", "absence_as_support", "representative_as_full_file_truth", "representative_family_as_independent_support", "domain_or_grain_inference", "micro_brain_similarity_as_confidence"],
  rules: [
    ...
    { ruleId: "R-WEAK-ONLY", description: "Containment, semantic retrieval, representative values, generic physical facts, or correlated context alone abstain.", outcome: "unknown" },
    ...
    { ruleId: "R-MB-PROBABLE", description: "A Micro Brain time candidate may be probable only when sparse and dense retrieval agree at rank one, compatible full-file date evidence exists, and no material conflict is present.", outcome: "probable" },
