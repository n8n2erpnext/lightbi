...
import type { BAInsight, BAInsightSeverity, BAInsightType, BARowEvidence } from './ba-decision-engine';
...
export function rowScopeLabel(scope?: RuntimeRowScope): string {
  switch (scope) {
    case 'full_file':
      return 'full file';
    case 'retained_rows':
...
export function selectNumericField(
  rows: Record<string, unknown>[],
  columns: string[],
...
export function firstAvailableField(rows: Record<string, unknown>[], candidates: string[]): string | null {
...
export function buildPreExecutionRows(
  rows: Record<string, unknown>[],
...
export function minePositiveRateInsight(
  rows: Record<string, unknown>[],
  columns: string[],
  categoryField: string | null,
  runtimeIntent: RuntimeIntent
...
export function mineBottomInsight(
  rows: Record<string, unknown>[],
  categoryField: string | null,
  numericField: string | null
): BAInsight | null {
...
export function mineSegmentSpreadInsight(
  rows: Record<string, unknown>[],
  categoryField: string | null,
  numericField: string | null
): BAInsight | null {
...
export function mineOutlierInsight(
  rows: Record<string, unknown>[],
  categoryField: string | null,
  numericField: string | null
): BAInsight | null {
...
export function mineKeyRiskInsight(
  rows: Record<string, unknown>[],
  columns: string[],
  preferredField: string | null
): BAInsight | null {
...
export function mineRequiredFieldGapInsight(
  columns: string[],
  aiBriefing: AISafeBriefing | undefined,
  runtimeIntent: RuntimeIntent
): BAInsight | null {
...
export function mineTrendInsight(
  rows: Record<string, unknown>[],
...
export function minePeriodOverPeriodInsight(
  rows: Record<string, unknown>[],
  xField: string | null | undefined,
  numericField: string | null,
  runtimeIntent: RuntimeIntent,
...
export function mineCoverageInsight(previewResult: DuckDBPreviewResult): BAInsight | null {
...
export function mineDataQualityInsight(aiBriefing?: AISafeBriefing): BAInsight | null {
...
export function mineSemanticCoverageGapInsight(aiBriefing?: AISafeBriefing): BAInsight | null {
...
export function insightPriority(insight: BAInsight): number {
