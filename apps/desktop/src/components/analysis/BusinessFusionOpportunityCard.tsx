  ...
  return (
    <section className="border-y border-[var(--lb-divider)] bg-white">
      ...
      <div className="grid gap-3 p-4 lg:grid-cols-[1fr_1fr]">
        <div className="border-y border-[var(--lb-divider)] bg-gray-50 px-3 py-3">
          <div className="flex items-center gap-2">
          ...
          <div className="mt-3 grid gap-2 sm:grid-cols-2">
            {overview.sources.map(source => (
              <div key={source.familyId} className="border-t border-[var(--lb-divider)] bg-white px-2 py-2 first:border-t-0">
        ...
        <div className="border-y border-[var(--lb-divider)] bg-gray-50 px-3 py-3">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 grid gap-2">
              {angles.map(angle => (
                <div key={angle} className="flex items-center gap-2 border-t border-[var(--lb-divider)] bg-white px-3 py-2 text-[12px] text-[#202123] first:border-t-0">
        ...
        {overview.caveats.length > 0 && (
          <div className="border-l-2 border-amber-300 bg-amber-50 px-3 py-3 lg:col-span-2">
            <div className="flex items-center gap-2">
        ...
        {onUseFusedDataset && (
          <div className="flex flex-col gap-2 border-y border-violet-200 bg-violet-50 px-3 py-3 sm:flex-row sm:items-center sm:justify-between lg:col-span-2">
            <div>
            ...
            <button
              ...
              className="lb-action-primary inline-flex shrink-0 items-center justify-center gap-2 px-4 py-2 text-[12px]"
            >
              Use fused dataset
