                ...
                <div id="easy-mode-perspectives" className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col gap-4">
                  ...
                  {currentDataset.canonicalPerspectiveId && currentDataset.analysisRows?.length > 0 && (
                    <PerspectiveCollectionResultCard
                      ...
                      deepDiveBrief={currentDataset.canonicalPerspectiveBrief} focusDeepDiveBrief={currentDataset.canonicalPerspectiveFocusBrief} focusSubject={currentDataset.canonicalPerspectiveFocusSubject}
                  ...
                  {datasetUnderstandingNext && currentDataset.sourceType !== 'canonical_perspective_collection' ? (
                    <>
                      <UnderstandingNextCard
                        ...
                        focusCandidates={focusSubjectCandidates} selectedFocusSubject={selectedFocusSubject} onSelectFocusSubject={handleSelectFocusSubject}
                        onClearFocusSubject={() => setSelectedFocusSubject(null)} onClearPerspective={() => { setSelectedPerspective(null); setSelectedBusinessView(null); setPreviewActionId(null); }}
                  ...
                  {pendingLocalBatch.status === "ready" && pendingLocalBatch.step === "family_selection" && multiSourceReviewSources.length > 0 && (
                    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500 mt-4 mb-4">
                      <CanonicalMultiSourceReview
                        ...
                        blockers={multiSourceBuildResult.blockers} selectedFocusSubject={selectedMultiSourceFocusSubject} onFocusSubjectChange={setSelectedMultiSourceFocusSubject}
                      />
                    </div>
                  )}
