...
export const MicroBrainPrivacyPanel: React.FC = () => {
  ...
  return <div className="space-y-5">
    ...
    <div className="grid gap-3 sm:grid-cols-2">
      <div className="flex gap-3 rounded-lg border border-slate-200 p-4"><HardDrive className="mt-0.5 h-5 w-5 text-slate-500"/><div><div className="font-medium text-slate-800">{t("On-device boundary")}</div><p className="mt-1 text-sm leading-6 text-slate-500">{t("Local learning evidence stays on this device and is not uploaded by this setting.")}</p></div></div>
