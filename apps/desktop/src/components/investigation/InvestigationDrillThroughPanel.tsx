...
export const InvestigationDrillThroughPanel: React.FC<InvestigationDrillThroughPanelProps> = ({
  ...
  return <div data-testid="investigation-drill-through" className="mt-5 border-y border-[var(--lb-divider)] bg-white">
    ...
    {drillResult && drillResult.rows.length > 0 && <div className="p-4">
      <section className="mb-4 border-l-2 border-blue-400 bg-blue-50/50 px-3 py-3" data-testid="drill-through-filters">
