import { ChevronDown, Compass, Search, ShieldCheck } from 'lucide-react';
import type { SingleSourceBAOverview } from '../../lib/single-source-ba-overview';
import type { SelectedSubjectInvestigationPlanV1 } from '../../lib/selected-subject-investigation';
...
export const SelectedSubjectInvestigationBoard: React.FC<{
  plan: SelectedSubjectInvestigationPlanV1;
  sourceOverviews: Array<{ sourceKey: string; overview: SingleSourceBAOverview }>;
  preferences: DisplayPreferences;
}> = ({ plan, sourceOverviews, preferences }) => {
